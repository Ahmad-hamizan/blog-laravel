<x-layout>
    ...
    <div class="my-4 py-2 px-4 mx-auto max-w-screen-xl lg:py-8 lg:px-0">
        <div class="grid gap-8 lg:grid-cols-3 md:grid-cols-2">
            ...
            >
                ...
                >
                    <a href="/posts?category={{ $post->category->slug }}">
                        <span
                            class="bg-{{ $post->category->color }}-100 text-primary-800 text-xs font-medium inline-flex items-center px-2.5 py-0.5 rounded dark:bg-primary-200 dark:text-primary-800 hover:scale-110 transition duration-100 ease-in-out"
                        >
                ...
                <div class="flex justify-between items-center">
                    <div class="flex items-center space-x-3">
                        <a
                            href="/posts?author={{ $post->author->name }}"
                        ...
                        >
                            ...
                            />
                            <span
                                class="font-medium dark:text-white text-sm hover:underline"
                            >
                                {{ $post->author->name }}
                            </span>
                        </a>
            ...
            @empty
            <div>
                <p class="font-semibold text-xl my-8">Article Not Found</p>
